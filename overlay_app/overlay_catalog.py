...
STINGER_META = {
    "pet.html": {"switches": [
        ...
        {"key": "font",   "label": "Font",      "type": "select", "default": "",
         "options": [
             ["", "Auto (DM Sans)"],
             ["Pacifico",        "Pacifico — rounded & fun"],
             ["Dancing Script",  "Dancing Script — elegant cursive"],
             ["Great Vibes",     "Great Vibes — romantic flourish"],
             ["Satisfy",         "Satisfy — casual script"],
             ["Sacramento",      "Sacramento — thin & airy"],
             ["Lobster",         "Lobster — bold & playful"],
         ]},
