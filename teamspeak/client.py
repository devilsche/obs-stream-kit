    ...
    def _run_loop(self):
        try:
            ...
            self.on_status(False,
                ...
                f"pip install ts3 ({e})")
            return
        # (Frueheres Monkey-patch auf ts3.escape.unescape entfernt —
        # hat Spaces im Output verschluckt und Felder zusammenmatschen
        # lassen. Lieber strikt parsen + UTF-8-Errors einzeln catchen.)
