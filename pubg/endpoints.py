...
class EndpointRegistry:
    ...
    def _matches_list(self, qs):
        ...
        rows = conn.execute("""
            ...
            LEFT JOIN participants pa
              ON pa.match_id = m.match_id AND pa.tenant_id = m.tenant_id AND pa.account_id = ?
            WHERE m.tenant_id = ?
    ...
    def _match_replay(self, qs):
        ...
        from pubg.db_pg import get_team_mapping_for_match
    ...
    PUBG_ACH_DESCRIPTIONS = {
        "english": {
            ...
            "career_hardest_lobby":    "Played a lobby tougher than any before it — measured by the career K/D of everyone in it",
        ...
        "german": {
            ...
            "career_hardest_lobby":    "Haerteste Lobby der Laufbahn — gemessen an der Karriere-K/D aller Mitspieler",
    ...
    PUBG_ICON_URLS = {
        ...
        "phoenix_chicken":         "/widgets-static/pubg/icons/phoenix_chicken.png",
        "first_top10":             "/widgets-static/pubg/icons/first_top10.png",
        "session_opener_chicken":  "/widgets-static/pubg/icons/session_opener_chicken.png",
        "session_opener_top10":    "/widgets-static/pubg/icons/session_opener_top10.png",
        # Kill tiers
        "five_kill_match":         "/widgets-static/pubg/icons/kills_5.png",
        "kills_5":                 "/widgets-static/pubg/icons/kills_5.png",
        "kills_7":                 "/widgets-static/pubg/icons/kills_7.png",
        "kills_10":                "/widgets-static/pubg/icons/kills_10.png",
        "kills_15":                "/widgets-static/pubg/icons/kills_15.png",
        "kills_20":                "/widgets-static/pubg/icons/kills_20.png",
        # DMG tiers
        "damage_500":              "/widgets-static/pubg/icons/damage_500.png",
        "damage_1000":             "/widgets-static/pubg/icons/damage_1000.png",
        "damage_1500":             "/widgets-static/pubg/icons/damage_1500.png",
        "damage_2000":             "/widgets-static/pubg/icons/damage_2000.png",
        "damage_2500":             "/widgets-static/pubg/icons/damage_2500.png",
        "damage_3000":             "/widgets-static/pubg/icons/damage_3000.png",
        # Long-range tiers
        "longest_kill_400":        "/widgets-static/pubg/icons/longest_kill_400.png",
        "longest_kill_600":        "/widgets-static/pubg/icons/longest_kill_600.png",
        "longest_kill_800":        "/widgets-static/pubg/icons/longest_kill_800.png",
        "longest_kill_1000":       "/widgets-static/pubg/icons/longest_kill_1000.png",
        # Beast chickens
        "beast_chicken":           "/widgets-static/pubg/icons/beast_chicken.png",
        "ultra_chicken":           "/widgets-static/pubg/icons/ultra_chicken.png",
        "god_mode_chicken":        "/widgets-static/pubg/icons/god_mode_chicken.png",
        # Hot-Drop / Inferno (Legacy-IDs point to new files)
        "burning_hell":            "/widgets-static/pubg/icons/burning_hell.png",
        "burning_hell_survivor":   "/widgets-static/pubg/icons/burning_hell_survivor.png",
        "hot_drop_match":          "/widgets-static/pubg/icons/hot_drop_match.png",
        "first_hot_drop":          "/widgets-static/pubg/icons/hot_drop_match.png",
        "hot_drop_match_survived": "/widgets-static/pubg/icons/hot_drop_match_survived.png",
        "first_hot_drop_survived": "/widgets-static/pubg/icons/hot_drop_match_survived.png",
        # Streaks
        "top3_streak":             "/widgets-static/pubg/icons/top3_streak.png",
        "top10_streak":            "/widgets-static/pubg/icons/top10_streak.png",
        "chicken_streak":          "/widgets-static/pubg/icons/chicken_streak.png",
        # Heist Kills
        "heist_kills_50":          "/widgets-static/pubg/icons/heist_kills_50.png",
        "heist_kills_75":          "/widgets-static/pubg/icons/heist_kills_75.png",
        "heist_kills_100":         "/widgets-static/pubg/icons/heist_kills_100.png",
        # Heist DMG
        "heist_dmg_8k":            "/widgets-static/pubg/icons/heist_dmg_8k.png",
        "heist_dmg_15k":           "/widgets-static/pubg/icons/heist_dmg_15k.png",
        "heist_dmg_20k":           "/widgets-static/pubg/icons/heist_dmg_20k.png",
        "heist_dmg_25k":           "/widgets-static/pubg/icons/heist_dmg_25k.png",
        # Heist Loot
        "heist_loot_25":           "/widgets-static/pubg/icons/heist_loot_25.png",
        "heist_loot_60":           "/widgets-static/pubg/icons/heist_loot_60.png",
        "heist_loot_120":          "/widgets-static/pubg/icons/heist_loot_120.png",
        # Heist Special
        "gold_brick_grab":         "/widgets-static/pubg/icons/gold_brick_grab.png",
        "money_bag_run":           "/widgets-static/pubg/icons/money_bag_run.png",
    ...
    def _session_date_pools(self, conn):
        ...
        # PG: date(text) gibt's nicht — wir nehmen substr(played_at, 1, 10)
        # (played_at ist ISO-Text 'YYYY-MM-DDTHH:MM:SSZ')
        br_dates = sorted({
    ...
    def _recent_achievements(self, qs):
        ...
        marked_n = 0
        if mark and items:
            # PG: strftime('%s','now') -> EXTRACT(EPOCH FROM NOW())::BIGINT
            conn.execute("""
    ...
    def _refetch_telemetry(self, qs):
        ...
        # Background-Thread braucht eigene PG-Connection (DSN aus .secrets).
        # PRAGMA database_list ist SQLite-only — entfernt; connect() laedt
        # die DSN selbst.
        if only_match:
            c = self.get_conn()
            c.execute(
        ...
        def _run():
            try:
                conn_bg = connect()
                # TODO(Task 12): run_bulk_telemetry_catchup muss tenant_id
                # akzeptieren — Poller-Refactor in Task 12.
    ...
    # TODO(Task 11b+): stamm_crew-Tabelle wurde nicht nach PG migriert.
    # Falls Feature live bleiben soll, Table-Definition in pubg/db_pg.py +
    # Migration ergaenzen. Bis dahin liefern die Endpoints leere/Fehler-
    # Antworten, damit das Front-end nicht crasht.
    def _stamm_get(self):
        return _ok([])

    def _stamm_add(self, body):
        return _err(501, "stamm_crew noch nicht nach PG migriert (Task 11b TODO)")
    ...
    def _debug_matches(self, qs):
        ...
        rows = conn.execute("""
            ...
            JOIN matches m ON m.match_id = pa.match_id AND m.tenant_id = pa.tenant_id
        ...
        if squad_only and self.my_account_id:
            for r in conn.execute("""
                WITH my_teams AS (
                  ...
                  WHERE mtm.tenant_id = ? AND mtm.account_id = ? AND m.map_name = ?
                )
