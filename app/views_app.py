...
TOOLS = [
    ...
    {"key": "weapon-performance",
     ...
     "desc": "Accuracy, Trefferzonen und Schaden je Waffe oder Spieler über Session, Tag, Woche oder alles.",
     "path": "tools/weapon-performance.html",
     "admin_only": False},
    {"key": "squad-playstyle",
     "label": "Squad-Spielstil",
     "desc": "Wer eröffnet die Gefechte, wie gehen sie aus, wer hängt zu weit weg und wer geht zuerst runter.",
     "path": "tools/squad-playstyle.html",
     "admin_only": False},
    {"key": "match-analysis",
     "label": "Match-Analyse",
     "desc": "Telemetrie-Auswertung eines Matches: Accuracy, Trefferzonen, Kill-Timeline und auffällige Treffermuster.",
